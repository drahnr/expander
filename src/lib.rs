...
fn expand_to_file(
    ...
    let Ok(mut f) = file_guard::try_lock(f.file_mut(), file_guard::Lock::Exclusive, 0, usize::MAX) else {
        ...
        let _lock = file_guard::lock(f.file_mut(), file_guard::Lock::Exclusive, 0, usize::MAX)?;
